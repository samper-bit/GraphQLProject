    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2025, 1, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2025, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2025, 1, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Celebrating a birthday." }
                });
